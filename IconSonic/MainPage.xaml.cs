...
public sealed partial class MainPage : Page
{
    ...
    public static string IncludeFrameAutomationName(string sizeLabel)
    {
        return $"Include {sizeLabel} in export";
    }

    public static string PaletteColorAutomationName(Color color)
    {
        return $"Use palette color #{color.A:X2}{color.R:X2}{color.G:X2}{color.B:X2}";
    }
